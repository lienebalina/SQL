...
const CREATE_MOVIE_KEYWORDS_TABLE = `create table ${MOVIE_KEYWORDS} (
  ...
  FOREIGN KEY(movie_id) REFERENCES movies(id) ON DELETE RESTRICT ON UPDATE CASCADE,
  FOREIGN KEY(keyword_id) REFERENCES keywords(id) ON DELETE RESTRICT ON UPDATE CASCADE
)`;
...
const CREATE_MOVIE_PRODUCTION_COMPANIES_TABLE = `create table ${MOVIE_PRODUCTION_COMPANIES} (
  ...
  FOREIGN KEY(movie_id) REFERENCES movies(id) ON DELETE RESTRICT ON UPDATE CASCADE,
  FOREIGN KEY(company_id) REFERENCES production_companies(id) ON DELETE RESTRICT ON UPDATE CASCADE
)`;
